	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<p style="margin-left: 10%; margin-top: 5%; font-size: 24px;"></p>
			<table  class="basic_box decor">
				...
				<tr>
					<td><b>Name: </b></td>
					<td><?php if(isset($_SESSION['name'])) echo $_SESSION['name']; ?><br></td>
				</tr>
				<tr>
					<td><b>Phone number: </b></td>
					<td><?php if(isset($_SESSION['phone'])) echo $_SESSION['phone']; ?><br></td>
				</tr>
				<tr>
					<td><b>Email address: </b></td>
					<td><?php if(isset($_SESSION['email'])) echo $_SESSION['email']; ?><br></td>
				</tr>
				<tr>
					<td><b>Date of birth: </b></td>
					<td><?php if(isset($_SESSION['dob'])) echo $_SESSION['dob']; ?><br></td>
				</tr>
				<tr>
					<td><b>ID Proof: </b></td>
					<td><?php if(isset($_SESSION['idproof'])) echo $_SESSION['idproof']; ?><br></td>
				</tr>
